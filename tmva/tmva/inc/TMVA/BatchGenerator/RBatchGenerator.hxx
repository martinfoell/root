...
private:
   ...
   // flattened buffers for datasets, chunks and temporary tensors (rows * cols)
...
public:
        ...
        fUseWholeFile(maxChunks == 0)
   {
      ...
      fTrainingBatchLoader = std::make_unique<RBatchLoader>(fBatchSize, fCols, fVecSizes, fNumTrainingEntries, fDropRemainder);         
      fValidationBatchLoader = std::make_unique<RBatchLoader>(fBatchSize, fCols, fVecSizes, fNumValidationEntries, fDropRemainder);
   }
